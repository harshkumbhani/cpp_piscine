...
int main() {
  ...
  std::cout << "Original Dog's first idea: " << originalDog->getIdea(1)
            << std::endl;

  Dog *copiedDog = new Dog(*originalDog); // Deep copy
  std::cout << "Copied Dog's first idea before change: "
            << copiedDog->getIdea(1) << std::endl;
  copiedDog->setIdea(90, "Sleep in the sun");
  // std::cout << "Copied Dog's first idea after change: "
  //           << copiedDog->getIdea(90) << std::endl;
  // std::cout << "Original Dog's first idea remains: " <<
  // originalDog->getIdea(1)
  //           << std::endl;
  ...
  *cat2 = *cat1; // Using assignment operator for deep copy
  ...
  std::cout << "Cat1's first idea after Cat2 changed: " << cat1->getIdea(1)
            << std::endl;
